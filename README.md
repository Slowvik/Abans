...
# Compilation instructions:
 Project was originally compiled with gcc 12.2.0 on Windows 10. The client works with Windows Socket API, hence can only be compiled and used on Windows. The re's only one file (client.cpp in src/Abans) and the library w2_32 needs to be linked at compile time as follows:
